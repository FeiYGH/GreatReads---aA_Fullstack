//Generated:2020-03-05 21:36:46// 39-509
(function(){
  var o = {
        $: function(el) {
            var x = el || o.divID, p = {
    ...
    (function() {
        var p = "4264199", n = JSON.parse('[]'), w = window, f = function(s) {
    ...
    var data = {
        params:window.ftParams_4264199||'',
        GUID:window.ftGUID_4264199||'99999999999',
        confID:window.ftConfID_4264199||'0',
        ftReturn: window.ftReturn_4264199||'',
        keyword:window.ftKeyword_4264199||'',
        ftId:window.ftId_4264199||'',
        imp:window.ftImp4264199,
        ftImpId:window.ftImp4264199 && window.ftImp4264199.impID || '',
        campaignID:'117744',
        cID:'93411',
        pID:'4264199',
        creativeID:'2643842',
        exttrack:["https://dpm.demdex.net/ibs:dpid=3047&dpuuid=[%FT_GUID%]&","https://servedby.flashtalking.com/segment/modify/xtx;;pixel/?name=NONSUB_Placement"],
        extscript:[""],
        clickTags: ["http://servedby.flashtalking.com/click/8/117744;4264199;2643842;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.xfinity.com?dfaid=4053494&cmp=0&cid=4053494"],
        placementDescription:'CORPQ12020BAUWSTNONDT4264199FT300x250',
        width:300,
        height:250,
        ...
        divID:'ftdiv4264199',
        phID:'ftpos4264199',
        frameID:'ftframe4264199',
        expID:'ftexpframe4264199',
        altImgID:'ftalt4264199',
        altText:'Click here',
        altImgTarget:'_blank',
        altimghref:'http://servedby.flashtalking.com/click/8/117744;4264199;2643842;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.xfinity.com?dfaid=4053494&cmp=0&cid=4053494',
        altImg:'http://servedby.flashtalking.com/imp/8/117744;4264199;204;gif;XfinityUS;CORPQ12020BAUWSTNONDT4264199FT300x250/?',
        viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/117744;4264199;271;pixel;XfinityUS;CORPQ12020BAUWSTNONDT4264199FT300x250/?',
        stump:'http://servedby.flashtalking.com',
        jsurl:'http://cdn.flashtalking.com/xre/426/4264199/2643842/js/j-4264199-2643842.js',
        file:'http://cdn.flashtalking.com/93411/2643842/DIGI_GM_MOV_OFFACQ_ENG_79MOC001377MOA218x24vPN_GETNOW_NOOFF_HTML_DSK_NOT_300x250.html',
        safeFrame: window.$sf && window.$sf.ext || false,
        serveDOM:'http://cdn.flashtalking.com',
        statBaseURL:'http://stat.flashtalking.com/reportV3/ft.stat?168206507-4264199;2643842;',
        adVis:false ? 1 : 0,
        centreAd:false,
        mvt:true,
        segment:window.ftSegment_4264199||'',
        segmentList:window.ftSegmentList_4264199||[],
        ...
        baggyFrameLimit:15,
        append:!!(window.ftImp4264199 && window.ftImp4264199.jsAppend),
        ...
        pageVisible: 'maybe',
        altimgborder: '0',
        secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m4264199')&&/^https:/.test(document.getElementById('ftscript_m4264199').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
        scriptLocation: document.getElementById('ftscript_m4264199'),
        ...
        qsVars:[
            ['ftguid', 'ftGUID_4264199'],
            ['ftcfid', 'ftConfID_4264199'],
            ['fttime', 'ftTimestamp_4264199'],
            ['ftsection', 'ftSection_4264199'],
            ['ftcustom', 'ftCustom_4264199'],
            ['ft_id', 'ftId_4264199'],
            ['ftimpid','ftImp4264199', 'impID']
        ]
    };
...
ft4264199.addEventListener("start",function(){
  //var usrSegs= "u0r,u0u,uyt,123".split(','),
  var usrSegs = (window.ftSegment_4264199 !== "") ? window.ftSegment_4264199.split(","): [],
   matched = [],
   getCCSegs = getCCSegs();
